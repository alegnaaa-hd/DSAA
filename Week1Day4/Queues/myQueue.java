...
/*
 * Objective: write a program that reverses the order of a queue
 * 
 * SIDENOTE:
 * we were originally supposed to reverse a STACK not a QUEUE but i read it wrong somehow and now we're here...
 */
